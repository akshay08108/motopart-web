...
export const demoStores: PartnerStore[] = [
  {
    id: "autohub-mumbai", name: "AutoHub Mumbai", owner: "Rohan Mehta", phone: "+91 98190 11022", businessHours: "9:00 AM – 9:00 PM", deliveryRadiusKm: 8, rating: 4.7, ratingCount: 128, distanceKm: 1.8,
    location: { id: "autohub-location", label: "Store", address: "Goregaon East, Mumbai", latitude: 19.1551, longitude: 72.8679 },
    paymentSettings: { upiId: "", upiDisplayName: "AutoHub Mumbai", upiEnabled: false, codEnabled: true },
  ...
  {
    id: "prime-spares", name: "Prime Spares", owner: "Neha Shah", phone: "+91 98201 33220", businessHours: "9:30 AM – 8:30 PM", deliveryRadiusKm: 10, rating: 4.7, ratingCount: 94, distanceKm: 2.4,
    location: { id: "prime-location", label: "Store", address: "Andheri West, Mumbai", latitude: 19.1364, longitude: 72.8296 },
    paymentSettings: { upiId: "", upiDisplayName: "Prime Spares", upiEnabled: false, codEnabled: true },
  ...
  {
    id: "motorworks", name: "MotorWorks", owner: "Aditya Rao", phone: "+91 98920 22018", businessHours: "10:00 AM – 8:00 PM", deliveryRadiusKm: 12, rating: 4.5, ratingCount: 67, distanceKm: 5.6,
    location: { id: "motorworks-location", label: "Store", address: "Chembur, Mumbai", latitude: 19.0522, longitude: 72.9005 },
    paymentSettings: { upiId: "", upiDisplayName: "MotorWorks", upiEnabled: false, codEnabled: true },
